...
export const IntentVariants: Story = {
  render: (args) => (
    <Stack spacing={2}>
      <Button {...args} intent="primary">Primary Action</Button>
      <Button {...args} intent="secondary">Secondary Action</Button>
      <Button {...args} intent="destructive">Destructive Action</Button>
      <Button {...args} intent="ghost">Ghost Action</Button>
    </Stack>
  ),
  args: {
      ...
      <Box p={4}>
        <Stack direction="row" justifyContent="space-between" alignItems="center" mb={3}>
          ...
          <Stack direction="row" spacing={2}>
            ...
            <Button intent="primary" size="small">Generate Report</Button>
          </Stack>
        </Stack>
        
        <Stack direction="row" spacing={2} justifyContent="center">
          <Button intent="primary" size="large">Optimize All Businesses</Button>
          <Button intent="secondary" size="large">Schedule Analysis</Button>
          <Button intent="ghost" size="large">View Trends</Button>
        </Stack>
      </Box>
    </Paper>
  ),
...
export const FormActions: Story = {
  render: () => (
    <Paper variant="glass">
      <Box p={4}>
        <Typography variant="h4" gutterBottom>Add New Business</Typography>
...
export const InteractiveDemo: Story = {
  render: () => (
    <Paper variant="elevated">
      <Box p={4}>
        <Typography variant="h4" gutterBottom>Revenue Optimization</Typography>
        ...
        <Stack direction="row" spacing={2}>
          <Button 
            intent="primary"
            onClick={() => alert("Optimization plan generated!")}
          >
            Implement Now
          </Button>
          <Button 
