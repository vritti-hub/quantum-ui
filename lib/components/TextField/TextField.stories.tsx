  ...
  render: (args) => (
    <Stack spacing={3}>
      ...
      <TextField
        ...
        state='success'
        label='Success State'
        placeholder='Validated successfully'
...
export const ResponsiveSizing: Story = {
        ...
        <Stack spacing={4} mt={3}>
          <Box>
            ...
            <Stack spacing={2}>
              <TextField
                label='Business Name'
                placeholder='Automatically sizes for optimal mobile and desktop experience'
              />
              <TextField
                label='Contact Information'
                placeholder='Height and padding adjust seamlessly across devices'
              />
            </Stack>
          </Box>
          ...
          <Box>
            ...
            <Stack spacing={2}>
              ...
              <TextField
                label='Success State'
                placeholder='Validated field with responsive design'
                state='success'
                message='Field validated successfully'
              />
              <TextField
                label='Warning State'
                placeholder='Warning styling maintains responsiveness'
                state='warning'
                message='Please review this information'
              />
              <TextField
                label='Error State'
                placeholder='Error styling with consistent sizing'
                state='error'
                message='This field contains an error'
              />
            </Stack>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates automatic responsive sizing behavior powered by semantic design tokens. No manual density selection needed.',
      },
    },
  },
};
...
export const BusinessRegistrationForm: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Complete business registration form showcasing TextField in realistic context with proper validation states.',
      },
    },
  },
};
    ...
    <Paper variant='surface' glass>
      <Box p={4}>
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={3} mt={3}>
          <Box flex={1}>
            <Stack spacing={2}>
              <TextField label='Business Search' placeholder='Search by name or ID...' fullWidth />
              <TextField label='Date Range' placeholder='Last 30 days' fullWidth />
              <TextField label='Metric Type' placeholder='Revenue, Customers, Growth' fullWidth />
            </Stack>
          </Box>
...
export const AccessibilityDemo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates TextField accessibility features including proper labeling, state announcements, and focus behavior.',
      },
    },
  },
};
...
export const InteractiveStateComparison: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Side-by-side interactive comparison of TextField states and use cases with automatic responsive sizing.',
      },
    },
  },
};
