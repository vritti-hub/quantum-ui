...
export const PaperTheme: Components<Theme>['MuiPaper'] = {
  styleOverrides: {
    root: {
      ...
      "&[data-variant='accent']": {
        background:
          'linear-gradient(135deg, rgba(var(--quantum-color-action-primaryRGB), 0.08) 0%, rgba(var(--quantum-color-action-primaryRGB), 0.12) 100%)',
        borderRadius: 'var(--quantum-borderRadius-large)',
        ...
        '&::before': {
          ...
          height: '1px',
          background:
            'linear-gradient(90deg, transparent 0%, rgba(var(--quantum-color-action-primaryRGB), 0.3) 50%, transparent 100%)',
        ...
        "&[data-emphasis='high']": {
          background:
            'linear-gradient(135deg, rgba(var(--quantum-color-action-primaryRGB), 0.15) 0%, rgba(var(--quantum-color-action-primaryRGB), 0.2) 100%)',
      ...
      "&[data-variant='container']": {
        ...
        // Clean, professional appearance - no hover effects
        // Designed for application UI containers
      ...
      // ========================================
      "&[data-glass='true']": {
        backgroundColor: 'rgba(var(--quantum-color-surface-glassRGB), 0.7)',
        backdropFilter: 'var(--quantum-glassmorphism-backdrop)',
        border: '1px solid rgba(var(--quantum-color-border-glassRGB), 0.6)',
        boxShadow: 'var(--quantum-shadows-glass)',
        ...
        "&[data-variant='accent']": {
          background:
            'linear-gradient(135deg, rgba(var(--quantum-color-action-primaryRGB), 0.1) 0%, rgba(var(--quantum-color-action-primaryRGB), 0.15) 100%)',
          backgroundColor: 'rgba(var(--quantum-color-surface-glassRGB), 0.7)',
      ...
      // ========================================
      // Transparent effect for all variants
      // ========================================
      "&[data-transparent='true']": {
        ...
        // Override any variant background when transparent is applied
        "&[data-variant='section']": {
          backgroundColor: 'transparent !important',
        },
